...
const slides = [
  {
    title: 'Welcome',
    description: 'This is the Imagination Engine. Type what you want, and watch it appear on a canvas.',
    icon: '✨'
  },
  {
    title: 'Blocks are Agents',
    description: 'Every shape on the canvas is a little AI. Connect them to build something bigger than any one of them.',
    icon: '🤖'
  },
  {
    title: 'The Canvas is yours',
    description: 'Save what you make. Come back to it. Share it. Launch it as an app, a game, a movie.',
    icon: '🎨'
  },
  {
        ...
        <div className="flex-1 overflow-hidden" ref={emblaRef}>
          <div className="flex h-full">
            {slides.map((slide, index) => (
              <div key={index} className="flex-[0_0_100%] min-w-0 flex flex-col items-center justify-center p-12 text-center space-y-6">
