...
## Deviation Protocol
If you determine that a new dependency *not* listed in the Atlas is absolutely required to satisfy the user's request, you **MUST** pause execution and prompt the user using the `ask_user` tool.
