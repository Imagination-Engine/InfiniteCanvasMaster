...
- **Custom Library Engine:** Orchestrated via `useLibraryStore`, providing a persistence pipeline for user-configured blocks. It bridges the transient canvas state to the permanent relational database, enabling a growing ecosystem of specialized agentic tools.
