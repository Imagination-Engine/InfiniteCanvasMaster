...
- **Imagination Canvas Kit (`@iem/imagination-canvas-kit`):** A sovereign, production-grade spatial engine implementing a typed object model and foundational state management for the infinite canvas.
...
- **State Management:** **Zustand** is utilized for lightweight, high-performance state management within the Imagination Canvas Kit, including local persistence for canvas and viewport states.
- **Schema Validation:** **Zod** is used for strict runtime validation of canvas entities and contracts.
