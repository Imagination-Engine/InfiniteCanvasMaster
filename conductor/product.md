...
11. **Atlas Surface (Knowledge Graph):** Transforming the canvas into a "Second Brain" knowledge graph, providing an auto-laying Atlas Canvas and RAG-primitive blocks (Ingestion, Retrieval, Synthesis) to map and interrogate uploaded semantic data.
