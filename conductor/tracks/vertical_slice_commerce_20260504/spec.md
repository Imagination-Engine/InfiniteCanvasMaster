# Specification: Vertical Slice Implementation: Commerce & Intentcasting Studio

## Overview

This track implements the "Deep Surface Runtime" (immersive UI) and specific artifact handling for the Commerce & Intentcasting Studio. It builds upon the foundational registry and interop engines established in prior tracks.
...
- [ ] A user can double-click a Commerce & Intentcasting Studio block to enter its specialized editor.
