...
## 4. Out of Scope
- Actually generating all 145 blocks manually; this track only builds the *generator* and the core Scribe UI. The students (and agents) will use the generator to fulfill the catalog over the 6 weeks.