...
- **Comprehensive Scaffolding:** Implement the strict requirement (Section 23) by generating a templated `README.md` for *every* directory within the monorepo that contains code or significant documentation.
