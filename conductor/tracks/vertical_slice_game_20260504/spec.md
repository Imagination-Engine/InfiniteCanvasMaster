# Specification: Vertical Slice Implementation: Game Studio

## Overview

This track implements the "Deep Surface Runtime" (immersive UI) and specific artifact handling for the Game Studio. It builds upon the foundational registry and interop engines established in prior tracks.
...
- [ ] A user can double-click a Game Studio block to enter its specialized editor.
