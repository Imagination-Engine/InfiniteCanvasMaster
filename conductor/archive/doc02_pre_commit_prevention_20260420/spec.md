...
- **Targeted Scanning:** Configure `lint-staged` to run `git-secrets` (along with standard linting and formatting tools) _only_ on staged files to maintain developer velocity while ensuring security.
