    ...
    <div className={`min-w-[280px] max-w-[360px] rounded-xl border bg-slate-900/95 p-3 text-slate-100 shadow-lg ${selected ? "border-sky-500" : "border-slate-700"}`}>
      ...
      <div className="space-y-3">
        <label className="block text-xs">
          <span className="mb-1 block text-slate-400">targetLanguage</span>
          <select
        ...
        <label className="block text-xs">
          <span className="mb-1 block text-slate-400">additionalInstructions</span>
          <textarea
      ...
      {result && (
        <div className="mt-2 rounded border border-slate-700 bg-slate-950 p-2 text-xs text-slate-300">
          <div className="mb-1 text-[10px] font-medium uppercase tracking-wider text-slate-500">Result</div>
