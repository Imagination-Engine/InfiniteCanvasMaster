        ...
        <header className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 pb-6 border-b border-white/5">
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto">
            <button
              ...
              className="rounded-full border border-white/10 px-6 py-2.5 text-[11px] font-black uppercase tracking-widest hover:bg-white/5 hover:border-brand-cyan/50 transition-all text-white flex items-center gap-2"
            >
            ...
            <button
              type="button"
              onClick={() => void logout()}
              className="rounded-full border border-white/10 px-6 py-2.5 text-[11px] font-black uppercase tracking-widest hover:bg-white/5 hover:border-brand-purple/50 transition-all text-white"
            >
              Logout
            </button>
          </div>
