...
export const NODE_CATALOG: NodeCatalog = {
  ...
  "slack.inviteUserToChannel": createEntry(
    ...
    { inputs: { userId: "", channelId: "" }, outputs: { result: {}, text: "" } },
    "action",
  ),
  "slack.sendChannelMessage": createEntry(
    ...
    { payload: ["trigger", "json", "text"], channelId: "text", message: "text" },
    { result: "json", text: "text" },
    { inputs: { channelId: "", message: "" }, outputs: { result: {}, text: "" } },
    "action",
  ),
  ...
  "slack.getMessage": createEntry(
    ...
    { inputs: { channelId: "", messageTs: "" }, outputs: { message: {}, json: {}, text: "" } },
    "action",
  ),
  "slack.readMessages": createEntry(
    ...
    { inputs: { channelId: "", limit: "20" }, outputs: { messages: [], text: "" } },
    "action",
  ),
  ...
  "slack.createChannel": createEntry(
    ...
    { inputs: { name: "", is_private: "false" }, outputs: { channel: {}, text: "" } },
    "action",
  ),
