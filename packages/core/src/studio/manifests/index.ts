...
export const TOOL_MOUNTS: Record<string, ToolMount> = {
  "gemini-chat": {
    id: "gemini-chat",
    name: "Gemini Chat",
...
export const writerStudioManifest: StudioManifest = {
  id: "writers-studio",
...
export const videoStudioManifest: StudioManifest = {
  id: "video-studio",
  name: "Video Studio",
...
export const gameStudioManifest: StudioManifest = {
  id: "game-studio",
  name: "Game Studio",
...
export const appCreationStudioManifest: StudioManifest = {
...
export const commerceStudioManifest: StudioManifest = {
  id: "commerce-studio",
...
export const agentStudioManifest: StudioManifest = {
  id: "agent-studio",
...
export const researchStudioManifest: StudioManifest = {
  id: "research-studio",
...
export const knowledgeStudioManifest: StudioManifest = {
  id: "knowledge-studio",
...
export const automationStudioManifest: StudioManifest = {
...
export const launchStudioManifest: StudioManifest = {
  id: "launch-studio",
  name: "Launch Studio",
...
export const mediaStudioManifest: StudioManifest = {
  id: "media-studio",
  name: "Media Studio",
  description:
...
export const brandStudioManifest: StudioManifest = {
  id: "brand-studio",
  name: "Brand Studio",
...
export const ALL_STUDIO_MANIFESTS: StudioManifest[] = [
...
class ToolMountRegistry {
  private mounts = new Map<string, ToolMount>();
