...
export const TimelineView: React.FC<BlockViewProps<any, any>> = ({ id, data, onParamsChange, onRun }) => {
  return (
    <div 
    ...
    >
      <div className="font-bold uppercase tracking-widest text-brand-purple mb-2">Timeline</div>
      <button
        onClick={onRun}
