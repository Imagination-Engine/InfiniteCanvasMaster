...
export const DocumentLoaderView: React.FC<BlockViewProps<any, any>> = ({ id, data, onParamsChange, onRun }) => {
  return (
    <div 
      data-testid="documentLoader-view"
    ...
    >
      <div className="font-bold uppercase tracking-widest text-brand-purple mb-2">DocumentLoader</div>
      <button
        onClick={onRun}
