...
export const IndexerView: React.FC<BlockViewProps<any, any>> = ({ id, data, onParamsChange, onRun }) => {
  return (
    <div 
      data-testid="indexer-view"
    ...
    >
      <div className="font-bold uppercase tracking-widest text-brand-purple mb-2">Indexer</div>
      <button
        onClick={onRun}
