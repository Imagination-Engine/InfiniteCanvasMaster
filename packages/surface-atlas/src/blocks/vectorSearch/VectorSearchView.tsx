...
export const VectorSearchView: React.FC<BlockViewProps<any, any>> = ({ id, data, onParamsChange, onRun }) => {
  return (
    <div 
      data-testid="vectorSearch-view"
    ...
    >
      <div className="font-bold uppercase tracking-widest text-brand-purple mb-2">VectorSearch</div>
      <button
        onClick={onRun}
