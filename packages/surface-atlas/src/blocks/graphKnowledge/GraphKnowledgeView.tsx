...
export const GraphKnowledgeView: React.FC<BlockViewProps<any, any>> = ({ id, data, onParamsChange, onRun }) => {
  return (
    <div 
      data-testid="graphKnowledge-view"
    ...
    >
      <div className="font-bold uppercase tracking-widest text-brand-purple mb-2">GraphKnowledge</div>
      <button
        onClick={onRun}
