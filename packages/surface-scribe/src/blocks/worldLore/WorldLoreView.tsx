...
export const WorldLoreView: React.FC<BlockViewProps<any, any>> = ({ id, data, onParamsChange, onRun }) => {
  return (
    <div 
      data-testid="worldLore-view"
    ...
    >
      <div className="font-bold uppercase tracking-widest text-brand-purple mb-2">WorldLore</div>
      <button
        onClick={onRun}
