...
export const ProofreaderView: React.FC<BlockViewProps<any, any>> = ({ id, data, onParamsChange, onRun }) => {
  return (
    <div 
      data-testid="proofreader-view"
    ...
    >
      <div className="font-bold uppercase tracking-widest text-brand-purple mb-2">Proofreader</div>
      <button
        onClick={onRun}
