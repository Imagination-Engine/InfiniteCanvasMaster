...
export const DialogueTreeView: React.FC<BlockViewProps<any, any>> = ({ id, data, onParamsChange, onRun }) => {
  return (
    <div 
      data-testid="dialogueTree-view"
    ...
    >
      <div className="font-bold uppercase tracking-widest text-brand-purple mb-2">DialogueTree</div>
      <button
        onClick={onRun}
