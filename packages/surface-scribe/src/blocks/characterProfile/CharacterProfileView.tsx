...
export const CharacterProfileView: React.FC<BlockViewProps<any, any>> = ({ id, data, onParamsChange, onRun }) => {
  return (
    <div 
      data-testid="characterProfile-view"
    ...
    >
      <div className="font-bold uppercase tracking-widest text-brand-purple mb-2">CharacterProfile</div>
      <button
        onClick={onRun}
