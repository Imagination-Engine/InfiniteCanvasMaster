...
export const createOrchestrator = async (
  ...
  const defaultInstructions = `
      ...
      - Conductor (Orchestration): trigger.manual, iem.conductor.if, iem.conductor.forEach, iem.conductor.webhook, iem.conductor.schedule, iem.conductor.saas, iem.conductor.router, iem.conductor.delay, iem.conductor.state, iem.conductor.errorBoundary, iem.conductor.subGraph
