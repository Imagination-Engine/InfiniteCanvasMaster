...
export const createOrchestrator = async (
  ...
  const defaultInstructions = `
      ...
      - Reel (Video): iem.reel.textToImage, iem.reel.character, iem.reel.scene, iem.studio.video (Reel Forge — connects up to 3 reference images + Veo prompt), iem.reel.timeline, iem.reel.export, iem.reel.dialogue, iem.reel.camera, iem.reel.lighting, iem.reel.transition, iem.reel.vfx, iem.reel.audioTrack
