export const INTENT_BENCHMARKS = [
  ...
  {
    id: "rag_pipeline",
    prompt: "Create a RAG pipeline that loads a PDF document, chunks the text, and executes a vector search.",
  ...
  },
  {
    ...
    prompt: "Build a 2D player controller with a joystick, a character sprite, and physics colliders.",
  ...
  {
    id: "cinematic_scene",
    prompt: "Set up a video scene with dramatic lighting, a camera pan, and export it.",
  ...
  {
    id: "autonomous_coder",
    prompt: "I need an autonomous coding loop that architects a spec, builds the code, tests it, and loops back if there's an error boundary.",
