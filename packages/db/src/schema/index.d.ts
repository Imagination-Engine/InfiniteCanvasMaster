export declare const users: import("drizzle-orm/pg-core").PgTableWithColumns<{
  ...
  columns: {
    ...
    name: import("drizzle-orm/pg-core").PgColumn<
      ...
      {}
    >;
    hasCompletedOnboarding: import("drizzle-orm/pg-core").PgColumn<
      {
...
export declare const canvases: import("drizzle-orm/pg-core").PgTableWithColumns<{
  name: "canvases";
  schema: undefined;
  columns: {
    id: import("drizzle-orm/pg-core").PgColumn<
...
export declare const nodes: import("drizzle-orm/pg-core").PgTableWithColumns<{
  ...
  columns: {
    id: import("drizzle-orm/pg-core").PgColumn<
      ...
      {}
    >;
    canvasId: import("drizzle-orm/pg-core").PgColumn<
      {
        name: "canvas_id";
        tableName: "nodes";
        dataType: "string";
...
export declare const customAgents: import("drizzle-orm/pg-core").PgTableWithColumns<{
  ...
  columns: {
    ...
    skills: import("drizzle-orm/pg-core").PgColumn<
      ...
      {}
    >;
    contextSources: import("drizzle-orm/pg-core").PgColumn<
      {
    ...
    purpose: import("drizzle-orm/pg-core").PgColumn<
      ...
      {}
    >;
    blockDefinition: import("drizzle-orm/pg-core").PgColumn<
      {
...
export declare const workspacesRelations: import("drizzle-orm").Relations<
  "workspaces",
  {
    ...
    canvases: import("drizzle-orm").Many<"canvases">;
  }
>;
export declare const canvasesRelations: import("drizzle-orm").Relations<
  "canvases",
  {
    workspace: import("drizzle-orm").One<"workspaces", true>;
    nodes: import("drizzle-orm").Many<"nodes">;
    edges: import("drizzle-orm").Many<"edges">;
  }
>;
export declare const nodesRelations: import("drizzle-orm").Relations<
  "nodes",
  {
    canvas: import("drizzle-orm").One<"canvases", true>;
    outgoingEdges: import("drizzle-orm").Many<"edges">;
    incomingEdges: import("drizzle-orm").Many<"edges">;
  }
>;
export declare const edgesRelations: import("drizzle-orm").Relations<
  "edges",
  {
    canvas: import("drizzle-orm").One<"canvases", true>;
    source: import("drizzle-orm").One<"nodes", true>;
    target: import("drizzle-orm").One<"nodes", true>;
  }
>;
export declare const a2aEventLogs: import("drizzle-orm/pg-core").PgTableWithColumns<{
  name: "a2a_event_logs";
  schema: undefined;
  columns: {
    id: import("drizzle-orm/pg-core").PgColumn<
...
export declare const a2aApprovals: import("drizzle-orm/pg-core").PgTableWithColumns<{
  name: "a2a_approvals";
  schema: undefined;
  columns: {
    id: import("drizzle-orm/pg-core").PgColumn<
