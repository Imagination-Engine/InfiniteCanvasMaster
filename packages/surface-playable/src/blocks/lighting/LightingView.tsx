...
export const LightingView: React.FC<BlockViewProps<any, any>> = ({ id, data, onParamsChange, onRun }) => {
  return (
    <div 
      data-testid="lighting-view"
    ...
    >
      <div className="font-bold uppercase tracking-widest text-brand-purple mb-2">Lighting</div>
      <button
        onClick={onRun}
