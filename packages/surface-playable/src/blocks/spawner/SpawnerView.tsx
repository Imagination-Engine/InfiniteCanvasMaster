...
export const SpawnerView: React.FC<BlockViewProps<any, any>> = ({ id, data, onParamsChange, onRun }) => {
  return (
    <div 
      data-testid="spawner-view"
    ...
    >
      <div className="font-bold uppercase tracking-widest text-brand-purple mb-2">Spawner</div>
      <button
        onClick={onRun}
