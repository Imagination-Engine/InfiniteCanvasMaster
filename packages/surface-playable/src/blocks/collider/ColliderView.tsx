...
export const ColliderView: React.FC<BlockViewProps<any, any>> = ({ id, data, onParamsChange, onRun }) => {
  return (
    <div 
      data-testid="collider-view"
    ...
    >
      <div className="font-bold uppercase tracking-widest text-brand-purple mb-2">Collider</div>
      <button
        onClick={onRun}
