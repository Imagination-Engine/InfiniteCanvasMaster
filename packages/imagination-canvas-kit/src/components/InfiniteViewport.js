...
export const InfiniteViewport = ({ children, registry }) => {
  ...
  return _jsxs("div", {
    ...
    className:
      "absolute inset-0 w-full h-full overflow-hidden outline-none touch-none bg-brand-bg-page",
    ...
    children: [
      _jsxs("div", {
        ...
        children: [
          _jsx(ConnectorLayer, {}),
          _jsx(AgentActivityLayer, {}),
          objects.map((obj) =>
            _jsx(ObjectRenderer, { object: obj, registry: registry }, obj.id),
          ),
          children,
        ],
      }),
