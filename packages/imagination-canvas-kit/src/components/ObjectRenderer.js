...
import { Maximize2, GripHorizontal, Activity } from "lucide-react";
const defaultRegistry = {
  note: NoteBlock,
  "rich-text": RichTextBlock,
  agent: AgentBlock,
  "openclaw-block": OpenClawBlockComponent,
  "openclaw.block": OpenClawBlockComponent,
  "openclaw.agent_group": OpenClawAgentGroupBlock,
};
export const ObjectRenderer = memo(({ object, registry = defaultRegistry }) => {
  ...
  const Component =
    BlockRegistry.resolve(object.blockKind) ||
  ...
  return _jsxs("div", {
    ...
    children: [
      _jsx("div", {
        ...
        children: _jsx("div", {
          className:
            "w-2.5 h-2.5 bg-brand-cyan/80 border border-white/20 shadow-lg shadow-brand-cyan/50 rounded-sm",
        }),
      }),
      _jsxs("div", {
        ...
        children: [
          _jsxs("div", {
            className:
              "h-10 border-b border-white/5 flex items-center justify-between px-3 bg-gradient-to-r from-black/60 to-black/20 shrink-0 select-none group/header relative overflow-hidden",
            children: [
              (object.status === "running" ||
                ...
                _jsx("div", {
                  className:
                    "absolute bottom-0 left-0 h-[2px] bg-brand-cyan shadow-[0_0_10px_rgba(0,194,255,0.8)] animate-[scan_2s_ease-in-out_infinite] w-1/3",
                }),
              _jsxs("div", {
                className: "flex items-center gap-2 overflow-hidden z-10",
                children: [
                  _jsx(GripHorizontal, {
                    size: 12,
                    className:
                      "text-white/20 opacity-0 group-hover/header:opacity-100 transition-opacity shrink-0",
                  }),
                  _jsx("div", {
                    className:
                      "text-brand-cyan flex items-center justify-center",
                    children: _jsx(BlockIcon, { size: 14 }),
                  }),
                  _jsx("span", {
                    className:
                      "text-[11px] font-black uppercase tracking-widest text-white truncate drop-shadow-md",
                    children: String(displayLabel),
                  }),
                  isWaiting &&
                    _jsx("div", {
                      "data-testid": "hitl-indicator",
                      className:
                        "w-2 h-2 rounded-full bg-amber-500 shadow-[0_0_8px_rgba(245,158,11,0.8)] animate-pulse",
              ...
              _jsx("div", {
                ...
                children: _jsx("button", {
                  ...
                  className:
                    "p-1.5 text-brand-cyan hover:bg-brand-cyan rounded-md transition-all ml-1 shadow-[0_0_10px_rgba(0,194,255,0.2)]",
                  title: "Expand",
            ...
            children: [
              _jsxs("div", {
                ...
                children: [
                  _jsx("span", {
                    className:
                      "text-[9px] font-black uppercase tracking-tighter text-white/30",
                    children:
              ...
              object.metadata?.description &&
                _jsx("p", {
                  ...
                  className:
                    "text-[10px] text-white/40 italic leading-relaxed line-clamp-2 mb-3",
                  children: object.metadata.description,
                }),
              _jsx("div", {
                className:
                  "flex-1 min-h-0 overflow-auto custom-scrollbar mb-4 pr-1",
              ...
              _jsxs("div", {
                className:
                  "mt-auto pt-3 border-t border-white/5 flex items-center justify-between",
                children: [
                  _jsx("div", {
                    className: "flex gap-1.5 overflow-hidden",
                    children: (object.metadata?.capabilities || [])
                      .slice(0, 2)
                      .map((cap) =>
                        _jsx(
                          "span",
                          {
                            className:
                              "px-1.5 py-0.5 bg-white/5 border border-white/10 rounded text-[8px] font-bold text-white/40 lowercase truncate max-w-[80px]",
                            children: cap,
                          },
                          cap,
                        ),
                  ...
                  _jsxs("div", {
                    ...
                    children: [
                      ...
                      _jsx("span", {
                        className:
                          "text-[8px] font-black uppercase tracking-widest text-white/20",
                        children: object.metadata?.runtime || "LIVE",
                      }),
                    ],
                  }),
                ],
