  ...
  return (
    (t.on = function (e, t) {
      ...
      return (
        e &&
          t &&
          ((a = (a = this._events = this._events || {})[e] =
            a[e] || []).includes(t) ||
            a.push(t)),
        this
      );
    ...
    (t.once = function (e, t) {
      ...
      return (
        e &&
          t &&
          (this.on(e, t),
          (((a = this._onceEvents = this._onceEvents || {})[e] = a[e] || {})[
            t
          ] = !0)),
        this
      );
    ...
    (t.emitEvent = function (e, t) {
      let a = this._events && this._events[e];
      if (a && a.length) {
        ((a = a.slice(0)), (t = t || []));
        var s,
  ...
  ((e, t) => {
    ...
    function n(e, t, a) {
      ...
      (s = "string" == typeof e ? document.querySelectorAll(e) : s)
        ...
        : l.error("Bad element for imagesLoaded " + (s || e));
    }
    (n.prototype = Object.create(e.prototype)).getImages = function () {
    ...
    return (
      (n.prototype.addElementBackgroundImages = function (t) {
        ...
        if (a) {
          let e = o.exec(a.backgroundImage);
          for (; null !== e; ) {
            var s = e && e[2];
            (s && this.addBackground(s, t), (e = o.exec(a.backgroundImage)));
          }
        }
      }),
      ...
      (n.prototype.progress = function (e, t, a) {
        (this.progressedCount++,
          ...
          this.options.debug && l && l.log("progress: " + a, e, t));
      }),
      ...
      ((a.prototype = Object.create(e.prototype)).check = function () {
      ...
      ((s.prototype = Object.create(a.prototype)).check = function () {
        (this.img.addEventListener("load", this),
          this.img.addEventListener("error", this),
...
var Swiper = (() => {
  ...
  function i(t, a) {
    ...
    Object.keys(a)
      ...
      .forEach((e) => {
        void 0 === t[e]
          ? (t[e] = a[e])
          : n(a[e]) && n(t[e]) && 0 < Object.keys(a[e]).length && i(t[e], a[e]);
      });
  }
  let t = {
    body: {},
    ...
    W = {
      ...
      updateSlides: function () {
        ...
        let r = i.params,
          ...
          c = Y(t, `.${i.params.slideClass}, swiper-slide`),
        ...
        if (void 0 !== l) {
            ...
            if (
              ...
              if ("auto" === r.slidesPerView) {
                ...
                if (
                  ...
                  o = i.isHorizontal() ? L(n, "width", !0) : L(n, "height", !0);
                else {
                  let a = d(t, "width"),
                    s = d(t, "padding-left"),
                    i = d(t, "padding-right"),
          ...
          if (
            ...
            (k(e, "--swiper-centered-offset-before", -m[0] + "px"),
              k(
                e,
        ...
        if (0 !== l.length) {
          ...
          for (let t = 0; t < l.length; t += 1) {
            ...
            (u && (i.visibleSlides.push(d), i.visibleSlidesIndexes.push(t)),
              j(d, u, r.slideVisibleClass),
              j(d, h, r.slideFullyVisibleClass),
              (d.progress = n ? -p : p),
      ...
      updateSlidesClasses: function () {
        let t = this,
          ...
          n = (e) => Y(s, `.${a.slideClass}${e}, swiper-slide` + e)[0],
          o,
          d,
          p;
        if (r)
          ...
          l
            ? ((o = e.find((e) => e.column === i)),
              (p = e.find((e) => e.column === i + 1)),
        ...
        if (
          ("wrapper" !== l.touchEventsTarget ||
            ((e, t) => {
              ...
              let s = t.contains(e);
              return (s =
                !s && a.HTMLSlotElement && t instanceof HTMLSlotElement
          ...
          if (
              ...
              ? (function (s, e) {
                  return (function e(t) {
                    ...
                    return t &&
                      t !== I() &&
                      t !== B() &&
                      ((a = (t = t.assignedSlot ? t.assignedSlot : t).closest(
                        s,
                      )) ||
                        t.getRootNode)
            ...
            if (Q(s, r, d)) {
              ...
              d = e && s.allowTouchMove && l.touchStartPreventDefault;
      ...
      slide: {
        slideTo: function (e, a, t, s, i) {
          ...
          if (n.cssMode) {
            ...
            e = V().isSafari;
            (w && !i && e && r.isElement && r.virtual.update(!1, !1, l),
              r.setTransition(a),
              r.setTranslate(v),
              r.updateActiveIndex(l),
              r.updateSlidesClasses(),
        ...
        slidePrev: function (t, a, s) {
          ...
          let u = c(n ? i.translate : -i.translate),
            m = r.map((e) => c(e)),
            h = e.freeMode && e.freeMode.enabled,
            f = r[m.indexOf(u) - 1];
          if (void 0 === f && (e.cssMode || h)) {
            let a;
            (r.forEach((e, t) => {
              u >= e && (a = t);
            }),
              void 0 !== a && (f = h ? r[a] : r[0 < a ? a - 1 : a]));
          }
          let v = 0;
          if (
            (void 0 !== f &&
              ...
              ? a.animating ||
                ...
                s.centeredSlides
                  ? t < a.loopedSlides - r / 2 ||
                    ...
                    ? (a.loopFix(),
                      (t = a.getSlideIndex(
                        Y(i, l + `[data-swiper-slide-index="${e}"]`)[0],
                      )),
                      M(() => {
                        a.slideTo(t);
                      }))
      ...
      loop: {
        loopCreate: function (e, t) {
          ...
          !s.loop ||
            ...
            (o = a.grid && s.grid && 1 < s.grid.rows),
            (l = s.slidesPerGroup * (o ? s.grid.rows : 1)),
            (n = a.slides.length % l != 0),
            (o = o && a.slides.length % s.grid.rows != 0),
            (d = (t) => {
              for (let e = 0; e < t; e += 1) {
                let e = a.isElement
            ...
            n
              ...
              : o &&
                (s.loopAddBlankSlides
                  ? (d(s.grid.rows - (a.slides.length % s.grid.rows)),
                    a.recalcSlides(),
                    a.updateSlides())
                  : A(
        ...
        loopFix: function (v) {
          ...
          if (M.params.loop) {
            ...
            let {
              ...
              { centeredSlides: h, initialSlide: f } = m;
            if (
              ((M.allowSlidePrev = !0),
              (M.allowSlideNext = !0),
              M.virtual && m.virtual.enabled)
            )
              (w &&
                (m.centeredSlides || 0 !== M.snapIndex
                  ? m.centeredSlides && M.snapIndex < m.slidesPerView
                    ? M.slideTo(
                        M.virtual.slides.length + M.snapIndex,
                        0,
                        !1,
                        !0,
                      )
                    : M.snapIndex === M.snapGrid.length - 1 &&
                      M.slideTo(M.virtual.slidesBefore, 0, !1, !0)
                  : M.slideTo(M.virtual.slides.length, 0, !1, !0)),
                (M.allowSlidePrev = p),
                (M.allowSlideNext = c));
            else {
              let e = m.slidesPerView;
              "auto" === e
                ? (e = M.slidesPerViewDynamic())
                : ((e = Math.ceil(parseFloat(m.slidesPerView, 10))),
                  h && e % 2 == 0 && (e += 1));
              v = m.slidesPerGroupAuto ? e : m.slidesPerGroup;
              let a = v;
              (a % v != 0 && (a += v - (a % v)),
                (a += m.loopAdditionalSlides),
                (M.loopedSlides = a));
              var C = M.grid && m.grid && 1 < m.grid.rows;
              d.length < e + a ||
              ("cards" === M.params.effect && d.length < e + 2 * a)
                ? A(
              ...
              let s = [],
                i = [],
                r = C ? Math.ceil(d.length / m.grid.rows) : d.length,
                t = x && r - f < e && !h,
                l = t ? f : M.activeIndex;
              void 0 === E
                ? (E = M.getSlideIndex(
              ...
              let n = 0,
                o = 0;
              var I =
                (C ? d[E].column : E) + (h && void 0 === y ? -e / 2 + 0.5 : 0);
              if (I < a) {
                n = Math.max(a - I, v);
                for (let t = 0; t < a - I; t += 1) {
                ...
                ((o = Math.max(I - (r - 2 * a), v)),
                  t && (o = Math.max(o, e - r + f + 1)));
                for (let e = 0; e < o; e += 1) {
                  let a = e - Math.floor(e / r) * r;
                  C
                    ? d.forEach((e, t) => {
                        e.column === a && i.push(t);
                      })
              ...
              if (
                ...
                "cards" === M.params.effect &&
                  d.length < e + 2 * a &&
                  (i.includes(E) && i.splice(i.indexOf(E), 1), s.includes(E)) &&
                ...
                "auto" === m.slidesPerView
                  ? M.updateSlides()
                  : C &&
                    ((0 < s.length && L) || (0 < i.length && P)) &&
                    M.slides.forEach((e, t) => {
                      M.grid.updateSlide(t, e, M.slides);
                    }),
                m.watchSlidesProgress && M.updateSlidesOffset(),
                w)
              )
                if (0 < s.length && L) {
                  if (void 0 === g) {
                    let e = M.slidesGrid[l],
                      t = M.slidesGrid[l + n] - e;
                    T
                      ? M.setTranslate(M.translate - t)
                      : (M.slideTo(l + Math.ceil(n), 0, !1, !0),
                        y &&
                          ((M.touchEventsData.startTranslate =
                            M.touchEventsData.startTranslate - t),
                          (M.touchEventsData.currentTranslate =
                            M.touchEventsData.currentTranslate - t)));
                  } else if (y) {
                    let e = C ? s.length / m.grid.rows : s.length;
                    (M.slideTo(M.activeIndex + e, 0, !1, !0),
                      (M.touchEventsData.currentTranslate = M.translate));
                  }
                } else if (0 < i.length && P)
                  if (void 0 === g) {
                    let e = M.slidesGrid[l],
                      t = M.slidesGrid[l - o] - e;
                    T
                      ? M.setTranslate(M.translate - t)
                      : (M.slideTo(l - o, 0, !1, !0),
                        y &&
                    ...
                    let e = C ? i.length / m.grid.rows : i.length;
                    M.slideTo(M.activeIndex - e, 0, !1, !0);
                  }
              if (
                ((M.allowSlidePrev = p),
                (M.allowSlideNext = c),
                M.controller && M.controller.control && !S)
              ) {
                let t = {
                  slideRealIndex: g,
                  direction: b,
                ...
                Array.isArray(M.controller.control)
                  ? M.controller.control.forEach((e) => {
                      !e.destroyed &&
                        e.params.loop &&
                        e.loopFix({
                          ...t,
                          slideTo:
                            e.params.slidesPerView === m.slidesPerView && w,
                        });
                    })
                  : M.controller.control instanceof M.constructor &&
                    ...
                    M.controller.control.loopFix({
                      ...t,
                      slideTo:
                        M.controller.control.params.slidesPerView ===
                          m.slidesPerView && w,
                    });
              }
            }
        ...
        setBreakpoint: function () {
          ...
          if (c && 0 !== Object.keys(c).length) {
            var u = I(),
              ...
              m = l.getBreakpoint(c, m, u);
            if (m && l.currentBreakpoint !== m) {
              let s = (m in c ? c[m] : void 0) || l.originalParams,
                e = te(l, d),
                t = te(l, s),
              ...
              var u = s.direction && s.direction !== d.direction,
                h = d.loop && (s.slidesPerView !== d.slidesPerView || u),
                f = d.loop,
                u =
                  (u && o && l.changeDirection(),
                  w(l.params, s),
                  l.params.enabled),
                v = l.params.loop;
              (Object.assign(l, {
                ...
                r && !u ? l.disable() : !r && u && l.enable(),
                (l.currentBreakpoint = m),
  ...
  class m {
    constructor() {
      ...
      let l = this,
        n =
          ((l.__swiper__ = !0),
          (l.support = q()),
          (l.device = R({ userAgent: a.userAgent })),
          (l.browser = V()),
          (l.eventsListeners = {}),
    ...
    getSlideIndex(e) {
      var { slidesEl: t, params: a } = this,
        t = P(Y(t, `.${a.slideClass}, swiper-slide`)[0]);
      return P(e) - t;
    }
    ...
    mount(s) {
      ...
      if (!i.mounted) {
        ...
        (!a &&
          ...
          e.append(a),
          Y(e, "." + i.params.slideClass).forEach((e) => {
            a.append(e);
          })),
          Object.assign(i, {
            el: e,
  ...
  return (
    ...
    m.use([
      function (e) {
        let t,
          { swiper: C, extendParams: a, on: s, emit: P } = e;
        a({
          virtual: {
            enabled: !1,
            slides: [],
        ...
        function L(e, t) {
          ...
          return (
            a.renderSlide
              ? "string" == typeof (s = a.renderSlide.call(C, e, t)) &&
                (D(i, s), (s = i.children[0]))
              : (s = C.isElement
                  ? z("swiper-slide")
                  : z("div", C.params.slideClass)),
            s.setAttribute("data-swiper-slide-index", t),
            a.renderSlide || D(s, e),
            a.cache && (C.virtual.cache[t] = s),
            s
          );
        }
        function l(m, h, f) {
          ...
          if (!(h && !b && 0 < y)) {
            let { addSlidesBefore: e, addSlidesAfter: t } = C.params.virtual,
              {
                from: a,
                to: s,
                slides: i,
            ...
            let n,
              ...
              p =
                ...
                h -
                  (d = w
                    ? ((o = Math.floor(v / 2) + g + t),
                      Math.floor(v / 2) + g + e)
                    : ((o = v + (g - 1) + t), (b ? v : g) + e))),
              c = h + o,
              u =
                (b || ((p = Math.max(p, 0)), (c = Math.min(c, i.length - 1))),
                (C.slidesGrid[p] || 0) - (C.slidesGrid[0] || 0));
            if (
              (b && h >= d
                ? ((p -= d), w || (u += C.slidesGrid[0]))
                : b && h < d && ((p = -d), w) && (u += C.slidesGrid[0]),
              ...
              if (C.params.virtual.renderExternal)
                ...
                var y = b ? -i.length : 0,
                  T = b ? 2 * i.length : i.length;
                for (let t = y; t < T; t += 1)
                  if (t >= p && t <= c) {
                    let e = S(t);
                    void 0 === s || m
                      ? x.push(e)
                      : (t > s && x.push(e), t < a && E.push(e));
                  }
                if (
                  (x.forEach((e) => {
                ...
                (Y(C.slidesEl, ".swiper-slide, swiper-slide").forEach((e) => {
                  e.style[n] = u - Math.abs(C.cssOverflowAdjustment()) + "px";
                }),
                  M());
              }
            else
        ...
        (s("beforeInit", () => {
          ...
          s("init update resize", () => {
            C.params.virtual.enabled &&
              C.params.cssMode &&
              k(C.wrapperEl, "--swiper-virtual-size", C.virtualSize + "px");
          }),
          Object.assign(C.virtual, {
          ...
          if (c.enabled) {
            ...
            if (
              ...
              if (
                ...
                let a = !1;
                if (
                  0 < N(c.el, `.${c.params.slideClass}, swiper-slide`).length &&
                  0 === N(c.el, "." + c.params.slideActiveClass).length
                )
                  return;
                let e = c.el,
                  t = e.clientWidth,
      ...
      function (e) {
        ...
        function s(e) {
          var t = e.target.closest(_(d.params.pagination.bulletClass));
          if (t) {
            e.preventDefault();
            var a,
              s,
              i,
              t = P(t) * d.params.slidesPerGroup;
            if (d.params.loop) {
              if (d.realIndex !== t) {
                ((a = d.realIndex), (s = t));
                let e =
        ...
        function r() {
          ...
          if (!i()) {
            ...
            if (
              ...
              if (
                (o.dynamicBullets &&
                  ((c = L(s[0], d.isHorizontal() ? "width" : "height", !0)),
                  t.forEach((e) => {
            ...
            t.forEach((s, e) => {
              if (
                ("fraction" === o.type &&
                  (s.querySelectorAll(_(o.currentClass)).forEach((e) => {
                    e.textContent = o.formatFractionCurrent(l + 1);
                  }),
                  s.querySelectorAll(_(o.totalClass)).forEach((e) => {
                ...
                ("horizontal" == i ? (t = e) : (a = e),
                  s.querySelectorAll(_(o.progressbarFillClass)).forEach((e) => {
                ...
                ("custom" !== s.type && D(e, a || ""),
                  "bullets" === s.type &&
                    d.pagination.bullets.push(
                      ...e.querySelectorAll(_(s.bulletClass)),
                    ));
              }),
        ...
        function E() {
          ...
          if (i.el) {
            ...
            ((e =
              ...
              e &&
                ((t = e.querySelector(_(o.params.scrollbar.dragClass))) ||
        ...
        let { swiper: p, extendParams: t, on: a } = e,
          ...
          s = () => {
            let { el: e, slides: t, progress: s, snapGrid: i } = p,
              a = Y(e, r);
            (p.isElement && a.push(...Y(p.hostEl, r)),
              a.forEach((e) => {
                l(e, s);
              }),
              t.forEach((e, t) => {
      ...
      function (e) {
        let { swiper: S, extendParams: t, on: a, emit: s } = e,
          T = B(),
          M =
            (t({
              zoom: {
        ...
        function L() {
          let e = S.params.zoom,
            t = C.imageWrapEl.getAttribute("data-swiper-zoom") || e.maxRatio;
          if (e.limitToOriginalSize && C.imageEl && C.imageEl.naturalWidth) {
            let e = C.imageEl.naturalWidth / C.imageEl.offsetWidth;
            return Math.min(e, t);
          }
          return t;
        }
        ...
        function v(t) {
          var e = "." + S.params.zoom.containerClass;
          return (
            t.target.matches(e) ||
            0 <
              [...S.hostEl.querySelectorAll(e)].filter((e) =>
                e.contains(t.target),
              ).length
          );
        }
        function g(t) {
          if (("mouse" === t.pointerType && n.splice(0, n.length), f(t))) {
            var a = S.params.zoom;
            if (((i = !1), (l = !1), n.push(t), !(n.length < 2))) {
              if (((i = !0), (C.scaleStart = h()), !C.slideEl)) {
                ((C.slideEl = t.target.closest(
                  `.${S.params.slideClass}, swiper-slide`,
                )),
                  C.slideEl || (C.slideEl = S.slides[S.activeIndex]));
                ...
                if (
                  ...
                  (C.imageEl = e),
                  (C.imageWrapEl = e
                    ? N(C.imageEl, "." + a.containerClass)[0]
                    : void 0),
                  !C.imageWrapEl)
                )
              ...
              if (C.imageEl) {
                let [e, t] =
                  n.length < 2
                    ? { x: null, y: null }
                    : ((a = C.imageEl.getBoundingClientRect()),
                      [
                        (n[0].pageX +
          ...
          f(t) &&
            ...
            n.length < 2 ||
              ...
              C.imageEl &&
                ...
                a.scale > C.maxRatio &&
                  (a.scale =
                    C.maxRatio - 1 + (a.scale - C.maxRatio + 1) ** 0.5),
                a.scale < e.minRatio &&
                  (a.scale =
        ...
        function y() {
          S.touchEventsData.preventTouchMoveFromPointerMove = !1;
        }
        function E(e) {
          var t = "mouse" === e.pointerType && S.params.zoom.panOnMouseMove;
          if (f(e) && v(e)) {
            var a = S.zoom;
            if (C.imageEl)
              if (P.isTouched && C.slideEl)
                if (t) I(e);
                  ...
                  P.isMoved ||
                    ((P.width = C.imageEl.offsetWidth || C.imageEl.clientWidth),
                    (P.height =
                      C.imageEl.offsetHeight || C.imageEl.clientHeight),
                    (P.startX = X(C.imageWrapEl, "x") || 0),
                    (P.startY = X(C.imageWrapEl, "y") || 0),
                  ...
                  (e.cancelable && e.preventDefault(),
                    e.stopPropagation(),
                    clearTimeout(u),
                    (S.touchEventsData.preventTouchMoveFromPointerMove = !0),
                    (u = setTimeout(() => {
                      S.destroyed || y();
                    })),
                    (P.isMoved = !0));
                  var s = (a.scale - M) / (C.maxRatio - S.params.zoom.minRatio),
                    { originX: i, originY: a } = C;
                  ((P.currentX =
                    P.touchesCurrent.x -
                    P.touchesStart.x +
                    P.startX +
                    ...
                    P.currentX < P.minX &&
                      (P.currentX =
                        P.minX + 1 - (P.minX - P.currentX + 1) ** 0.8),
                    P.currentX > P.maxX &&
                      (P.currentX =
                        P.maxX - 1 + (P.currentX - P.maxX + 1) ** 0.8),
                    P.currentY < P.minY &&
                      (P.currentY =
                        P.minY + 1 - (P.minY - P.currentY + 1) ** 0.8),
                    P.currentY > P.maxY &&
                      (P.currentY =
                        P.maxY - 1 + (P.currentY - P.maxY + 1) ** 0.8),
                    c.prevPositionX || (c.prevPositionX = P.touchesCurrent.x),
                    c.prevPositionY || (c.prevPositionY = P.touchesCurrent.y),
                    c.prevTime || (c.prevTime = Date.now()),
                    (c.x =
                      (P.touchesCurrent.x - c.prevPositionX) /
                      (Date.now() - c.prevTime) /
                      2),
                    (c.y =
                      (P.touchesCurrent.y - c.prevPositionY) /
                      (Date.now() - c.prevTime) /
                      2),
                    Math.abs(P.touchesCurrent.x - c.prevPositionX) < 2 &&
                      (c.x = 0),
                    Math.abs(P.touchesCurrent.y - c.prevPositionY) < 2 &&
                      (c.y = 0),
                    (c.prevPositionX = P.touchesCurrent.x),
                    (c.prevPositionY = P.touchesCurrent.y),
                    (c.prevTime = Date.now()),
        ...
        function I(e) {
          ...
          M <= 1 ||
            ...
            (f(e) &&
              v(e) &&
              ((t = T.getComputedStyle(C.imageWrapEl).transform),
              (t = new T.DOMMatrix(t)),
              o
                ? ((l = (e.clientX - d.x) * p),
                  (a = (e.clientY - d.y) * p),
                  ...
                  (s = C.slideWidth),
                  (i = C.slideHeight),
                  (n = -(s = Math.min(s / 2 - n / 2, 0))),
                  (r = -(i = Math.min(i / 2 - r / 2, 0))),
                  (l = Math.max(Math.min(P.startX + l, n), s)),
                  (n = Math.max(Math.min(P.startY + a, r), i)),
                  (C.imageWrapEl.style.transitionDuration = "0ms"),
                ...
                : ((o = !0),
                  ...
                  (P.startY = t.f),
                  (P.width = C.imageEl.offsetWidth || C.imageEl.clientWidth),
                  (P.height = C.imageEl.offsetHeight || C.imageEl.clientHeight),
                  (C.slideWidth = C.slideEl.offsetWidth),
                  (C.slideHeight = C.slideEl.offsetHeight))));
        }
        function k(w) {
          ...
          if (!C.slideEl) {
            ...
            let e = C.slideEl.querySelector("." + y.containerClass);
            ((e =
              e &&
              e.querySelectorAll(
                "picture, img, svg, canvas, .swiper-zoom-target",
              ...
              (C.imageEl = e),
              (C.imageWrapEl = e
                ? N(C.imageEl, "." + y.containerClass)[0]
                : void 0));
          }
          if (C.imageEl && C.imageWrapEl) {
            ...
            (S.params.cssMode &&
              ...
              C.slideEl.classList.add("" + y.zoomedSlideClass),
              (t =
                void 0 === P.touchesStart.x && w
                  ? ((e = w.pageX), w.pageY)
                  : ((e = P.touchesStart.x), P.touchesStart.y)));
            var y = M,
              E = "number" == typeof w ? w : null,
              x =
                (1 === M &&
                  E &&
                  ((e = void 0),
            ...
            ((b.scale = E || x),
              ...
              !w || (1 === M && E)
                ? ((l = 0), (n = 0))
                : ((v = C.slideEl.offsetWidth),
                  (g = C.slideEl.offsetHeight),
                  (a = H(C.slideEl).left + T.scrollX),
                  (s = H(C.slideEl).top + T.scrollY),
                  (i = a + v / 2 - e),
                  (r = s + g / 2 - t),
                  (o = C.imageEl.offsetWidth || C.imageEl.clientWidth),
                  (d = C.imageEl.offsetHeight || C.imageEl.clientHeight),
                  (p = o * b.scale),
                  (c = d * b.scale),
                  ...
                  (n =
                    0 < y &&
                    E &&
                    "number" == typeof P.currentX &&
                    "number" == typeof P.currentY
                      ? ((l = (P.currentX * b.scale) / y),
                        (P.currentY * b.scale) / y)
                      : ((l = i * b.scale), r * b.scale)),
                  (l = l < u ? u : l) > h && (l = h),
                  (n = n < m ? m : n) > f && (n = f)),
              E && 1 === b.scale && ((C.originX = 0), (C.originY = 0)),
              (P.currentX = l),
              (P.currentY = n),
        ...
        function A() {
          ...
          if (!C.slideEl) {
            S.params.virtual && S.params.virtual.enabled && S.virtual
              ? (C.slideEl = Y(S.slidesEl, "." + S.params.slideActiveClass)[0])
              : (C.slideEl = S.slides[S.activeIndex]);
            ...
            ((e =
              ...
              (C.imageEl = e),
              (C.imageWrapEl = e
                ? N(C.imageEl, "." + t.containerClass)[0]
                : void 0));
          }
          C.imageEl &&
            C.imageWrapEl &&
            ...
            (C.originX = 0),
            (C.originY = 0),
            S.params.zoom.panOnMouseMove) &&
            ((d = { x: 0, y: 0 }), o) &&
            ((o = !1), (P.startX = 0), (P.startY = 0));
        }
        function z(e) {
          var t = S.zoom;
        ...
        function D() {
          ...
          if (!a.enabled) {
            ...
            (S.wrapperEl.addEventListener("pointerdown", g, t),
              S.wrapperEl.addEventListener("pointermove", w, e),
              ["pointerup", "pointercancel", "pointerout"].forEach((e) => {
                S.wrapperEl.addEventListener(e, b, t);
              }),
              S.wrapperEl.addEventListener("pointermove", E, e));
          }
        }
        function G() {
          var a = S.zoom;
          if (a.enabled) {
            a.enabled = !1;
            let { passiveListener: t, activeListenerWithCapture: e } = O();
            (S.wrapperEl.removeEventListener("pointerdown", g, t),
              S.wrapperEl.removeEventListener("pointermove", w, e),
              ["pointerup", "pointercancel", "pointerout"].forEach((e) => {
                S.wrapperEl.removeEventListener(e, b, t);
              }),
              S.wrapperEl.removeEventListener("pointermove", E, e));
          }
        }
        (Object.defineProperty(S.zoom, "scale", {
          ...
          a("touchEnd", (e, t) => {
            if (S.zoom.enabled) {
              var a = S.zoom;
              if (((n.length = 0), C.imageEl)) {
                if (!P.isTouched || !P.isMoved)
                  return void ((P.isTouched = !1), (P.isMoved = !1));
                ...
                var s = c.x * e,
                  ...
                  r =
                    ...
                    0 !== c.y && (t = Math.abs((i - P.currentY) / c.y)),
                    Math.max(e, t)),
                  s = ((P.currentX = s), (P.currentY = i), P.width * a.scale),
                  i = P.height * a.scale;
                ((P.minX = Math.min(C.slideWidth / 2 - s / 2, 0)),
                  (P.maxX = -P.minX),
                  (P.minY = Math.min(C.slideHeight / 2 - i / 2, 0)),
          ...
          a("transitionEnd", () => {
            S.zoom.enabled && S.params.zoom.enabled && x();
          }),
          a("slideChange", () => {
            S.zoom.enabled && S.params.zoom.enabled && S.params.cssMode && x();
          }),
        ...
        function v(e) {
          if (13 === e.keyCode || 32 === e.keyCode) {
            ...
            if (
              ...
              e.target.matches(_(n.params.pagination.bulletClass))
            ) {
              if (n.navigation && n.navigation.prevEl && n.navigation.nextEl) {
                let e = O(n.navigation.prevEl);
                (O(n.navigation.nextEl).includes(a) &&
              ...
              n.pagination &&
                a.matches(_(n.params.pagination.bulletClass)) &&
                a.click();
            }
          }
        }
              ...
              g() &&
                n.pagination.bullets.forEach((e) => {
                  (n.params.pagination.clickable &&
                    ...
                    e.matches(_(n.params.pagination.bulletActiveClass))
